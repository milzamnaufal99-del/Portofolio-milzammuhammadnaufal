 ...
 * @property {string} year        - Year the milestone occurred (e.g. "2021")
 * @property {string} title       - Short event title displayed as the heading
 * @property {string} description - Genuine description of the milestone and its significance
 */
